...
public class AltaEncuentro extends AppCompatActivity{
    ...
    private final String INSERT = IP + "/insertar_encuentro.php";
    ...
    //Variables para hacer la inserción
    private int capacidad = 2, apuntados = 1;
    private String fecha, hora, descripcion, lat="latt", lon="lonn";
            ...
            public void onClick(View v) {
                if(fecha == null || hora == null){
                    ...
                    if(descripcion.equals("")){
                        ...
                        new InserEncuentrotTask().execute(INSERT,descripcion, deporte_id+"",apuntados+"", capacidad+"", fecha, hora, lat, lon);
                    }
                }
            }
        });
    ...
    public class InserEncuentrotTask extends AsyncTask<String,Void,String> {
        ...
        protected void onPostExecute(String s) {
            if (s.equals("1")) { //La consulta se ha realizado correctamente
                Snackbar.make(btnCrear,"Encuentro creado correctamente",Snackbar.LENGTH_LONG).show();
